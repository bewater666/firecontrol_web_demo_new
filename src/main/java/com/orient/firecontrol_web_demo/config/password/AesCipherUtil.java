package com.orient.firecontrol_web_demo.config.password;

import com.orient.firecontrol_web_demo.config.common.Base64Utils;
import com.orient.firecontrol_web_demo.config.common.HexConvertUtil;
...
public class AesCipherUtil {
    ...
    public static String enCrypto(String str) {
        try {
            ...
            secureRandom.setSeed(Base64Utils.decode(encryptAESKey).getBytes());
            ...
            return Base64Utils.encode(HexConvertUtil.parseByte2HexStr(cipherByte));
    ...
    public static String deCrypto(String str) {
        try {
            ...
            byte[] cipherByte = c.doFinal(HexConvertUtil.parseHexStr2Byte(Base64Utils.decode(str)));
