...
import com.orient.firecontrol_web_demo.config.jwt.JwtFilter;
import com.orient.firecontrol_web_demo.config.shiro.cache.CustomCacheManager;
...
public class ShiroConfig {
     ...
     * @param account
     */
    public static void reloadAuthorizing(UserRealm myRealm,String account) {
